...
public class _08_StringContains {
    public static void main(String[] args) {
        // contains: bir stringin içinde karakter(lerin) var olup olmadığını
        ...
        System.out.println("cumle.contains(p) = " + cumle.contains("p"));
        System.out.println("cumle = " + cumle.contains("m"));
