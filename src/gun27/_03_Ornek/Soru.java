...
public class Soru {
    ...
    public static void main(String[] args) {
        ...
        ders3.saat=3;
        //üniversitede bulunan dersleri ve kredilerini tanımladık


        Student ogr1=new Student();
        ogr1.name ="Özge Gül Yangın";
        ogr1.maxSaat=10;
        // öğrenci tanımladık ve max alabileceği krediyi/saati yazdık


        // dersEkle metodu ile yukarıdaki dersleri öğrencinin
